---
layout: default
title: Simple_ACGAN.md
categories:
- Game
tags:
- Game
---
//Description: Simple_ACGAN (一个简单的ACGAN例子)

//Create Date: 2022-01-27 10:28:39
...
category_cross_entropy = tf.keras.losses.SparseCategoricalCrossentropy(from_logits=True) # 交
叉熵损失 多输出分类损失

def discriminator_loss(real_output, real_cat_out, fake_output, label): # 接收真图 和 真实图片
的分类  假图 加label
