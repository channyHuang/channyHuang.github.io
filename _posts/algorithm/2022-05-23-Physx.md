					...
					* Scene::rigidBodyNarrowPhase 串联Task
						...
						* Scene::postBroadPhase
							* AABBManager.postBroadPhase
								...
								* processBPPairs (DeletedPairHandler.processPair)
									* processPair
						...
						* Scene::postBroadPhaseContinuation
							* finishBroadPhase 获取粗阶段的结果，mNbNewPairs
								* OverlapFilterTask
						* Scene::postBroadPhaseStage2 (PostBroadPhaseStage2Task)
...
# BroadPhase 三种算法  
BroadPhase.update 输入参数BroadPhaseUpdateData中包含了add/remove/update的handle数据，输出BroadPhasePair
* BroadPhaseABP.update
	* setUpdateData 有优化点：可能存在不必要的copy
		...
		* ABP.Region_prepareOverlaps //static、dynamic、kinematic三个BoxManager
			* prepareData
				* purgeRemovedFromSleeping 有优化点：内存分配可优化
				* RadixSort.sort
				...
				* findAllOverlaps //static-dynamic、dynamic-dynamic
					* doCompleteBoxPruning_ //dynamic-dynamic
						...
						* doCompleteBoxPruning_Leaf
							* outputPair 赋值ABP的ABP_PairManager/ABP_MM
					* doBipartiteBoxPruning_Leaf 有优化点：bit冗余 // acitve dynamic - static, dynamic - kinematic
	* postUpdate
		* ABP.finalize
			* ABP_PairManager.computeCreatedDeletedPairs 有优化点：可能存在不必要的copy // copy新增和删除的Pairs，处理碰撞开始/持续/分离期
