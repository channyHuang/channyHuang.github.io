...
信息是系统有序程度的度量,表现为<font color = violet>负熵</font>。  
信息的特征：  
...
* 三态模型。进程具有三种最基本的状态,分别是<font color = violet>运行、就绪和阻塞。</font>

### 3.2.2 信号量与PV操作  
<font color = violet> m个进程n个资源，则 $$ PV \in [-m + n， n] $$ 
</font>  
...
3. 请求与保持
4. 环路
对死锁的处理,常用的方法有<font color = violet> 死锁的预防、避免和检测与解除等</font>方法。 
### 3.2.4 线程管理
...
1. 不分大小写
2. 不写前导0
3. 相邻0缩写::，只出现一次，为最长相邻0串，长度相同时取最前
## 4.3 局域网和广域网
* 无线局域网 IEEE 802.11标准
## 4.4 网络互连与常用设备
路由选择协议：
...
## 18.3
### 18.3.1 防火墙
<font color = red>一般可以分为包过滤型防火墙、电路级网关型防火墙、应用网关型防火墙、代理服务型防火墙、状态检测型防火墙和自适应代理型防火墙。</font>
...
## 18.6 容灾与业务持续
<font color = red> 容灾与恢复 </font> (论)  

### 18.6.3 业务持续性规划（Business Continuity Planning, BCP）
## 18.7 安全管理措施

# 第19章 <font color = red> 系统可靠性分析与设计 </font> (论)
## 19.1 系统可靠性概述
系统可靠性指标
* 平均无故障时间（MTTF）
* 平均故障修复时间（MTTR）
...
# 第20章 <font color = red> 项目管理 </font> (论)
## 20.1 项目开发计划
## 20.2 范围管理
## 20.3 进度管理
...
### 20.6.1 软件质量模型
![SAr_SoftwarePolicyModel](./images/SAr_SoftwarePolicyModel.png)
